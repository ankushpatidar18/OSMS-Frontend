...
export const getClasses = () => axios.get(`${ApiUrl}/admit-card/classes`);
export const getExams = (className) => axios.get(`${ApiUrl}/admit-card/exams`, { params: className ? { class: className } : undefined });
