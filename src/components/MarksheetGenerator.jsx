...
const generatePDF = () => {
  ...
  selectedStudents.forEach((student, index) => {
    ...
    pdf.text(`SESSION : 2024-25`, 105, 48, { align: 'center' });
    ...
    pdf.line(25, 58, 25, 74); // After S.NO
    pdf.line(45, 58, 45, 74); // After ROLL NO
    pdf.line(80, 58, 80, 74); // After SSSID
    pdf.line(115, 58, 115, 74); // After SCHOLAR NO
    pdf.line(150, 58, 150, 74); // After SCHOOL CODE
    pdf.line(10, 66, 200, 66); // Horizontal line between header and data
    ...
    autoTable(pdf, {
      ...
      didParseCell: function(data) {
        // Make all exam result entries bold with white background and black text
        data.cell.styles.fontStyle = 'bold';
        data.cell.styles.fillColor = [255, 255, 255]; // White background
        data.cell.styles.textColor = [0, 0, 0]; // Black text
      }
    ...
    // Grading system header with background
    pdf.setFillColor(240, 240, 240);
    ...
    autoTable(pdf, {
      ...
      didParseCell: function(data) {
        // Make all grading system entries bold with black text
        if (data.column.index === 0) {
          // Keep first column (Grade labels) with gray background and black text
          data.cell.styles.fontStyle = 'bold';
          data.cell.styles.fillColor = [240, 240, 240];
          data.cell.styles.textColor = [0, 0, 0]; // Black text
        } else {
          // Make other columns bold with white background and black text
          data.cell.styles.fontStyle = 'bold';
    ...
    // Signature section with proper spacing at bottom of page
    const signatureY = 282; // Moved closer to bottom
    
    // Draw underlines above signature labels
