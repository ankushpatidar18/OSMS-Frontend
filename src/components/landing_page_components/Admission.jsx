      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Card className="text-center">
            <CardHeader>
              <div className="bg-blue-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2" aria-label="Fill Application Form">
          ...
          <Card className="text-center">
            <CardHeader>
              <div className="bg-green-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2" aria-label="Pay Application Fee">
          ...
          <Card className="text-center">
            <CardHeader>
              <div className="bg-purple-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2" aria-label="Attend Interview">
          ...
          <Card className="text-center">
            <CardHeader>
              <div className="bg-orange-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2" aria-label="Confirmation">
                <CheckCircle className="h-6 w-6 text-orange-600" aria-hidden="true" />
              </div>
        ...
        <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-blue-600">
              <a href="/admission/apply" aria-label="Apply Online for Admission">
                Apply Online Now
              </a>
            </Button>
          </div>
